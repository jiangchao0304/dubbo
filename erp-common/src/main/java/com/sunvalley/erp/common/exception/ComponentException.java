...
public class ComponentException  extends RuntimeException implements ErpException {
    ...
    public ComponentException(String exceptionCode) {
        this(null,exceptionCode,"",null);
    }

    public ComponentException(String exceptionCode, String extraMsg) {
       this(null,exceptionCode,extraMsg,null);
    }

    public ComponentException(Map<String, Object> param ,String exceptionCode, String extraMsg) {
        this(param,exceptionCode,extraMsg,null);
    }
    public ComponentException(String exceptionCode, String extraMsg, StackTraceElement[] stackTrace) {
        this(null,exceptionCode,extraMsg,stackTrace);
    }

    public ComponentException(Map<String, Object> param , String exceptionCode, String extraMsg, StackTraceElement[] stackTrace) {
        super();
