package com.sunvalley.erp.to.common;
 ...
 * */
public class PagerTO<T> implements Serializable {
	...
	public PagerTO(int pageNo, int pageSize)
	{
		this.pageNo = pageNo;
		this.pageSize = pageSize;
	}
	
	public PagerTO(int pageNo, int pageSize, String filterSql){
		this.pageNo=pageNo;
		this.pageSize=pageSize;
