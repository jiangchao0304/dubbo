 ...
 */
public class PreSkuTO implements Serializable {
    ...
    private List<PreSkuGridTO> preSkuList;   //sku列表
    private List<PackageSkuTO> packageSkuList;
    ...
    public List<PackageSkuTO> getPackageSkuList() {
        return packageSkuList;
    }


    public void setPackageSkuList(List<PackageSkuTO> packageSkuList) {
        this.packageSkuList = packageSkuList;
    }

    public List<PreSkuGridTO> getPreSkuList() {
        return preSkuList;
    }

    public void setPreSkuList(List<PreSkuGridTO> preSkuList) {
