 ...
 */
public class UpdateSkuBaseInfoTO implements Serializable {
    ...
    public List<ItemLocaleTO> getItemLocaleDTOList() {
        return itemLocaleTOList;
    }

    public void setItemLocaleDTOList(List<ItemLocaleTO> itemLocaleDTOList) {
        this.itemLocaleTOList = itemLocaleDTOList;
    }
}
